...
namespace gmail_netcore_pof
{
    public static class GmailAPIHelper
    {
        ...
        static string ApplicationName = "Gmail Reader Application";

        public static async Task<GmailService> GetService()
        {
        ...
        public static async Task<List<string>> GetAttachmentsAsync(string userId, string messageId, String outputDir)
        {
            try
            {
                List<string> FileName = new List<string>();
                GmailService GServices = await GetService();
